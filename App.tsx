...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50">
      {/* HERO SECTION */}
      <header className="hero-gradient-8 min-h-screen flex items-center relative overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 text-center lg:text-left">
              <div className="inline-flex items-center px-4 py-2 bg-white/20 rounded-full text-white text-sm mb-6 backdrop-blur border border-white/20 shadow-lg">
                ...
                Đề cương Cuối kỳ 2 – Lớp 8
              </div>
              <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6 leading-tight drop-shadow-md tracking-tight">
                Unit 7 → 11 <br />
                <span className="text-emerald-300">Đề cương Cuối kỳ 2</span>
              </h1>
              <p className="text-xl text-white/90 mb-8 max-w-xl mx-auto lg:mx-0 font-light leading-relaxed">
                Đề cương chính thức HKII – Tiếng Anh 8 Global Success. Mệnh đề thời gian, Quá khứ tiếp diễn, Đại từ sở hữu, Câu tường thuật. Quiz Random 20 câu / 5 phút.
              </p>
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                <a
                  href="#content"
                  className="pulse-btn bg-white text-emerald-800 px-8 py-4 rounded-full font-bold shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-1 flex items-center border border-white/50"
                >
            ...
            <div className="flex-1 hidden lg:block">
              <div className="relative">
                <div className="absolute -inset-1 bg-gradient-to-r from-emerald-400 via-violet-500 to-blue-500 rounded-3xl blur opacity-30 animate-pulse"></div>
                <div className="relative w-80 h-auto bg-white/10 rounded-3xl backdrop-blur-xl p-8 animate-float mx-auto border border-white/40 shadow-2xl">
                  <div className="flex justify-between items-start mb-6">
                    <div className="text-5xl bg-gradient-to-br from-emerald-400 to-teal-600 p-4 rounded-2xl shadow-lg">📝</div>
                    <div className="text-5xl bg-gradient-to-br from-violet-400 to-purple-600 p-4 rounded-2xl shadow-lg">🔬</div>
                    <div className="text-5xl bg-gradient-to-br from-blue-400 to-indigo-600 p-4 rounded-2xl shadow-lg">💬</div>
                  </div>
                  <div className="text-white font-bold text-2xl mb-4">Cuối kỳ 2</div>
                  <div className="space-y-3 text-white/90 font-medium text-sm">
                    <div className="flex items-center p-2 bg-white/10 rounded-lg"><Globe className="w-4 h-4 mr-3 text-emerald-300" /> Adverb Clauses of Time</div>
                    <div className="flex items-center p-2 bg-white/10 rounded-lg"><Cpu className="w-4 h-4 mr-3 text-sky-300" /> Past Continuous</div>
                    <div className="flex items-center p-2 bg-white/10 rounded-lg"><Stars className="w-4 h-4 mr-3 text-yellow-300" /> Possessive Pronouns</div>
                    <div className="flex items-center p-2 bg-white/10 rounded-lg"><FlaskConical className="w-4 h-4 mr-3 text-purple-300" /> Reported Speech</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-5">
              <div className="relative">
                <div className="w-16 h-16 bg-gradient-to-br from-emerald-600 to-blue-700 rounded-full flex items-center justify-center text-white text-2xl font-bold shadow-lg ring-4 ring-emerald-50">
                  VT
                </div>
              ...
              <div>
                ...
                <p className="text-slate-500 text-sm">Chuyên gia luyện thi & Phân tích ngữ pháp</p>
              </div>
            </div>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group flex items-center gap-3 bg-white border border-slate-200 text-slate-700 px-6 py-3 rounded-full font-medium hover:border-emerald-600 hover:text-emerald-700 transition shadow-sm hover:shadow-md"
            >
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6">
                Nội dung <span className="gradient-text">đề cương chính thức</span>
              </h2>
              <p className="text-slate-500 text-lg mt-2 max-w-2xl mx-auto">
                Unit 7-11: Mệnh đề thời gian, Trạng từ tần suất, Quá khứ tiếp diễn, Giới từ & Đại từ sở hữu, Câu tường thuật. Phonetics, Reading, Writing.
              </p>
            </div>
              ...
              {lessons.map((lesson) => (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col grow">
                    ...
                    <h4 className="font-bold text-slate-800 text-lg mb-2 leading-tight group-hover:text-emerald-700 transition-colors">
                      {lesson.title}
                    </h4>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-500 text-lg max-w-2xl mx-auto">
                Random 20 câu từ ngân hàng {quizQuestions.length} câu. Thời gian: 5 phút. Bao phủ: Phonetics, Grammar, Reading, Writing, Error Correction.
              </p>
            </div>
      ...
      <footer className="bg-slate-900 text-white py-16 mt-auto">
        <div className="container mx-auto px-6 text-center">
          <div className="mb-10">
            <h4 className="text-2xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 via-violet-400 to-blue-400 inline-block">
              Global Success 8 - Đề cương Cuối kỳ 2
            </h4>
            <p className="text-slate-400 max-w-lg mx-auto">
              Unit 7-11: Mệnh đề thời gian, Quá khứ tiếp diễn, Giới từ & Đại từ sở hữu, Câu tường thuật. Phonetics, Reading, Writing. Năm học 2025-2026.
            </p>
          </div>
          <div className="flex justify-center gap-6 mb-10">
            <a href="https://zalo.me/0814666040" className="w-12 h-12 bg-white/5 text-emerald-400 rounded-full flex items-center justify-center hover:bg-emerald-600 hover:text-white hover:scale-110 transition-all duration-300 ring-1 ring-white/10">
